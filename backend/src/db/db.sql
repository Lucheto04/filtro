CREATE DATABASE db_campus_alquiler_Lucheto; 
USE db_campus_alquiler_Lucheto; 
...
FROM Cliente c
JOIN Reserva r
WHERE 2 = c.ID_Cliente, "Pendiente" = r.Estado ;
...
WHERE 1 = r.ID_Reserva;

/* Punto 21   
Listar los alquileres con fecha de inicio entre '2023-07-05' y
'2023-07-10'.  */